...
namespace ChartJs.Blazor.ChartJS.LineChart
{
    public abstract class Axis
    {
        ...
        /// <summary>
        /// The ID is used to link <see cref="LineChartDataset{TData}"></see> and <see cref="Axis"></see> together. Referenced in <see cref="LineChartDataset{TData}.XAxisID"></see> and <seealso cref="LineChartDataset{TData}.YAxisID"/>
        /// </summary>
        [JsonProperty("id")]
